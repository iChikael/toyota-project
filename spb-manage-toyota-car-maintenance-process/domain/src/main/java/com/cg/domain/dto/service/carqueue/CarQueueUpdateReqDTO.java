...
@Getter
@Setter
public class CarQueueUpdateReqDTO implements Validator  {
    ...
    public CarQueue toCarQueue () {
        return new CarQueue()
                .setCarNumberPlates(carNumberPlates)
                .setFullName(fullName)
                .setPhone(phone)
                .setStatus(EStatusCarQueue.getEStatusCarQueueByName(status));
    }

    @Override
    public boolean supports(Class<?> clazz) {
        return CarQueueUpdateReqDTO.class.isAssignableFrom(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {
        CarQueueUpdateReqDTO carQueueUpdateReqDTO = (CarQueueUpdateReqDTO) target;
        String carPlate = carQueueUpdateReqDTO.carNumberPlates;
        String phone = carQueueUpdateReqDTO.phone;
