...
@Getter
@Setter
public class CarUpdateReqDTO implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return CarUpdateReqDTO.class.isAssignableFrom(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {
        CarUpdateReqDTO carUpdateReqDTO = (CarUpdateReqDTO) target;
    }
