package com.cg.domain.dto.service.orderService.orderRepairItemAccessory;
...
@Getter
@Setter
public class OrderRepairItemAccessoryResDTO {
    private Long id;
    ...
    public OrderRepairItemAccessoryResDTO(Long id, String accessoryName, EUnit accessoryUnit, BigDecimal accessoryQuantity, Accessory accessory) {
        this.id = id;
