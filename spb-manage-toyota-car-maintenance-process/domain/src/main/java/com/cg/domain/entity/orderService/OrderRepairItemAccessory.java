...
@Setter
@Entity
@Table(name = "order_repair_item_accessory")
public class OrderRepairItemAccessory extends BaseEntity {
    @Id
    ...
    @ManyToOne
    @JoinColumn(name = "order_repair_id", referencedColumnName = "id", nullable = false)
    private OrderRepairItem orderRepairItem;
