...
const ListOrderServiceUseUndercarriageArea = () => {
  ...
  const handleClickDetailOrderServiceUseGeneralRepairArea = (orderId) => {
    navigate(
      '/technical/service-area/undercarriage-area/order-services/' + orderId
    )
  }
...
export default ListOrderServiceUseUndercarriageArea
