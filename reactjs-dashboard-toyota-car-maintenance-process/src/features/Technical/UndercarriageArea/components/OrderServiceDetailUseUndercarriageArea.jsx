...
const OrderServiceDetailUseUndercarriageArea = () => {
  ...
  return (
    <Box m="20px" pb="20px">
      ...
      >
        {' '}
        <Header title="Hạng mục dịch vụ khu vực gầm máy" />
        <Button
          variant="contained"
          type="button"
          color="secondary"
...
export default OrderServiceDetailUseUndercarriageArea
