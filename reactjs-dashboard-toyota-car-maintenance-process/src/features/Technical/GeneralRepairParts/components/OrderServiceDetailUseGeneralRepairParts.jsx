...
const OrderServiceDetailUseGeneralRepairArea = () => {
  ...
  return (
    <Box m="20px" pb="20px">
      ...
      >
        <Header title="Hạng mục dịch vụ khu vực sửa chữa chung" />
        <Button
          variant="contained"
          type="button"
          color="secondary"
          ...
          sx={{ mt: '10px', mb: '20px' }}
        >
          Danh sách lệnh sửa chữa khu vực sửa chữa chung
        </Button>
      </Grid>
...
export default OrderServiceDetailUseGeneralRepairArea
