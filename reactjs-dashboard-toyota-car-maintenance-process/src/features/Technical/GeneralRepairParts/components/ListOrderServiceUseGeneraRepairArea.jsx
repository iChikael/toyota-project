...
const ListOrderServiceUseGeneraRepairArea = () => {
  ...
  const handleClickDetailOrderServiceUseGeneralRepairArea = (orderId) => {
    navigate(
      '/technical/service-area/general-repair-area/order-services/' + orderId
    )
  }
  ...
  return (
    <Box m="20px">
      ...
      >
        <Header title="Khu vực sửa chữa chung" />
        <BackListButton
...
export default ListOrderServiceUseGeneraRepairArea
