...
const ListOrderServiceUseRefrigerationArea = () => {
  ...
  const handleClickDetailOrderServiceUseGeneralRepairArea = (orderId) => {
    navigate(
      '/technical/service-area/refrigeration-area/order-services/' + orderId
    )
  }
  ...
  return (
    <Box m="20px">
      ...
      >
        <Header title="Khu vực điện, điện lạnh" />
        <BackListButton
...
export default ListOrderServiceUseRefrigerationArea
