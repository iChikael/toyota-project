...
const OrderServiceDetailUseRefrigerationArea = () => {
  ...
  return (
    <Box m="20px" pb="20px">
      ...
      >
        <Header title="Hạng mục dịch vụ khu vực điện, điện lạnh" />
        <Button
          variant="contained"
          type="button"
          color="secondary"
          ...
          sx={{ mt: '10px', mb: '20px' }}
        >
          Danh sách lệnh sửa chữa khu vực điện, điện lạnh
        </Button>
      </Grid>
      <Box
        m="20px 0 0 0"
...
export default OrderServiceDetailUseRefrigerationArea
