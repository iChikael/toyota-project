...
import { getServiceAreaById } from 'app/serviceAreaSlice'
import BackListButton from 'components/Button/BackListButton'

const ListOrderServiceUseCoPaintedArea = () => {
  ...
  const handleClickDetailOrderServiceUseGeneralRepairArea = (orderId) => {
    dispatch(getServiceAreaById({ id: serviceAreaId }))
    navigate('/technical/service-area/co-paint-area/order-services/' + orderId)
  }
...
export default ListOrderServiceUseCoPaintedArea
