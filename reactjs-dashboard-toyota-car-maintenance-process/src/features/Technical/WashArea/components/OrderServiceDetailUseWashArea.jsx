...
const OrderServiceDetailUseWashArea = () => {
  ...
  return (
    <Box m="20px" pb="20px">
      ...
      >
        <Header title="Hạng mục dịch vụ khu vực rửa xe" />
        <Button
          variant="contained"
          type="button"
          color="secondary"
          ...
          sx={{ mt: '10px', mb: '20px' }}
        >
          Danh sách lệnh sửa chữa khu vực rửa xe
        </Button>
      </Grid>
...
export default OrderServiceDetailUseWashArea
